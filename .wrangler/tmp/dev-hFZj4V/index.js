...
var getCustomer = createRoute({
  ...
  request: { params: IdParam },
  responses: {
    200: { description: "Customer detail", content: { "application/json": { schema: external_exports.object({ customer: CustomerSchema, jobs: external_exports.array(JobSchema) }) } } },
    404: { description: "Not found", content: { "application/json": { schema: ErrorSchema } } }
  }
});
...
// .wrangler/tmp/bundle-V445yP/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-V445yP/middleware-loader.entry.ts
